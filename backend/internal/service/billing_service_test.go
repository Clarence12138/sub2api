...
func TestComputeTokenBreakdown_GptImage2ImageEditIssue4386(t *testing.T) {
	...
	cost := svc.computeTokenBreakdownForModel("gpt-image-2", pricing, tokens, 1.0, "", false)
...
func TestServiceTierCostMultiplier(t *testing.T) {
	...
	require.InDelta(t, 2.0, serviceTierCostMultiplier("ultrafast", "gpt-5.6-sol"), 1e-12)
...
func TestComputeTokenBreakdown_ExplicitZeroImagePrice_NoFallback(t *testing.T) {
	...
	bd := svc.computeTokenBreakdownForModel("claude-sonnet-4", pricing, tokens, 1.0, "", false)
