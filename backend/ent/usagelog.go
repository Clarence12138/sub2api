...
type UsageLog struct {
	...
	// 边缘中转短名，如 vmiss/zouter；直连为空
	EdgeName *string `json:"edge_name,omitempty"`
	// 用户实际访问的入口 Host，如 vmiss.nexapi.us.ci
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldRequestID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldUpstreamResponseModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldEdgeName, usagelog.FieldEntryHost, usagelog.FieldImageSize, usagelog.FieldImageInputSize, usagelog.FieldImageOutputSize, usagelog.FieldImageSizeSource, usagelog.FieldVideoResolution:
...
func (_m *UsageLog) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usagelog.FieldEdgeName:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field edge_name", values[i])
			} else if value.Valid {
				_m.EdgeName = new(string)
				*_m.EdgeName = value.String
			}
		case usagelog.FieldEntryHost:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field entry_host", values[i])
			} else if value.Valid {
				_m.EntryHost = new(string)
				*_m.EntryHost = value.String
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	if v := _m.EdgeName; v != nil {
		builder.WriteString("edge_name=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := _m.EntryHost; v != nil {
		builder.WriteString("entry_host=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
