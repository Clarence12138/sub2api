...
func init() {
	...
	// usagelogDescEdgeName is the schema descriptor for edge_name field.
	usagelogDescEdgeName := usagelogFields[34].Descriptor()
	// usagelog.EdgeNameValidator is a validator for the "edge_name" field. It is called by the builders before save.
	usagelog.EdgeNameValidator = usagelogDescEdgeName.Validators[0].(func(string) error)
	// usagelogDescEntryHost is the schema descriptor for entry_host field.
	usagelogDescEntryHost := usagelogFields[35].Descriptor()
	// usagelog.EntryHostValidator is a validator for the "entry_host" field. It is called by the builders before save.
	usagelog.EntryHostValidator = usagelogDescEntryHost.Validators[0].(func(string) error)
