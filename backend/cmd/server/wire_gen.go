...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountUsageWindowRepository := repository.NewAccountUsageWindowRepository(db)
	codexWindowRecorder := service.ProvideCodexWindowRecorder(accountUsageWindowRepository)
	openAIQuotaService := service.ProvideOpenAIQuotaService(accountRepository, proxyRepository, openAITokenProvider, privacyClientFactory, openAIGatewayService, codexWindowRecorder)
	usageCache := service.NewUsageCache()
	accountUsageService := service.ProvideAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, grokQuotaFetcher, grokQuotaService, openAIQuotaService, usageCache, identityCache, tlsFingerprintProfileService, openAIGatewayService, codexWindowRecorder, accountUsageWindowRepository)
