...
```text
ghcr.io/clarence12138/sub2api:0.1.136-clarence.1
ghcr.io/clarence12138/sub2api:latest
```

## Current customization

This fork currently carries product-specific behavior changes:

- Keep deployment defaults pointed at the Clarence fork and GHCR image.
- Keep ops dashboard health-score thresholds configurable.
- Align TTFT diagnosis with the configured threshold instead of a hard-coded value.
