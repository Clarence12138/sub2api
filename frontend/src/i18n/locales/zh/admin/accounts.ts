export default {
    accounts: {
      ...
      quotaRefreshNotify: {
        label: '额度刷新通知',
        hint: '开启后，可多选关注的上游用量窗口；窗口重置、额度恢复时通过 SMTP 向管理员主邮箱发送通知。',
        windowsLabel: '关注的窗口',
        windowsRequired: '请至少选择一个用量窗口',
        windows: {
          five_hour: '5 小时',
          seven_day: '7 天',
      ...
      stats: {
        ...
        costVsPercentHint: '横轴是本窗本站花费，纵轴是官方占比。从窗口起点补到当前点（约每 $100 或每 1% 一个点）。虚线是反推额度。当前斜率是最近 1 个官方百分点花了多少钱，不是总金额÷总占比。提前重置按两次 reset 之间计窗。',
        chartZoomHint: '滚轮缩放，拖动平移，双击复位。',
        zoomIn: '放大',
        zoomOut: '缩小',
        resetChartZoom: '复位缩放',
        costAxis: '金额 (USD)',
