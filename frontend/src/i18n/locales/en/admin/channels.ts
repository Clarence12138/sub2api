export default {
    ...
    subscriptions: {
      ...
      resetQuotaChooseWindows: "Choose which usage windows to reset for '{user}'. Usage will be zeroed and restarted.",
      selectAtLeastOneWindow: 'Select at least one usage window to reset',
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      bulk: {
        selectGroups: 'Select by Group',
        selectionSummary: '{groups} groups and {subscriptions} subscriptions selected; {excluded} excluded',
        actualSelectionCount: '{count} can actually be reset',
        clearSelection: 'Clear selection',
        resetSelected: 'Bulk Reset',
        confirmHint: 'Confirm the target scope and choose which usage windows to reset. Groups include active subscriptions across all pages.',
        previewLoading: 'Calculating the actual affected scope…',
        previewSummary: '{total} subscriptions matched; {valid} can be reset and {failed} will fail',
        previewFailed: 'Unable to preview the bulk reset scope',
        failureTitle: 'The following subscriptions failed and can be retried:',
        resetSuccess: 'Successfully reset {count} subscriptions',
        partialFailure: 'Bulk reset partially completed: {success} succeeded and {failed} failed'
      },
