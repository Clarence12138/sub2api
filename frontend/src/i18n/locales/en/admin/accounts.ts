export default {
    accounts: {
      ...
      quotaRefreshNotify: {
        label: 'Quota Refresh Notify',
        hint: 'When enabled, pick which upstream usage windows to watch. Admins are emailed via SMTP when a selected window resets.',
        windowsLabel: 'Watched windows',
        windowsRequired: 'Select at least one usage window',
        windows: {
          five_hour: '5 hour',
          seven_day: '7 day',
          ...
          antigravity: 'Antigravity model quotas',
        },
      },
      ...
      stats: {
        ...
        tabWindows: 'Windows',
        windowsSubtitle: 'Official 5h/7d reset windows with local spend and inferred weekly limit',
        windowRange: 'Days',
        windowType: 'Window',
        windowPeriod: 'Range',
        peakPercent: 'Peak %',
        ...
        noWindowSnapshots: 'No sealed official windows yet. Snapshots start after the next probe or request.',
        ...
        costVsPercentHint: 'X is local spend in this window, Y is official percent. The dashed line is the inferred quota through the origin. Early upstream resets use the interval between two reset times.',
        costAxis: 'Cost (USD)',
        percentAxis: 'Used percent',
        ...
        limitInsufficient: 'Not enough samples for slope',
        limitTrendHint: 'Inferred as local standard cost / official peak percent. Only this gateway’s traffic is included, so outside ChatGPT usage makes the limit look lower.'
      },
      usageWindow: {
