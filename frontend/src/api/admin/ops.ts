...
export interface OpsMetricThresholds {
  ...
  health_score_error_rate_full_percent?: number | null // 健康评分错误率满分点
  health_score_error_rate_zero_percent?: number | null // 健康评分错误率零分点
  health_score_ttft_p99_full_ms?: number | null        // 健康评分 TTFT P99 满分点
  health_score_ttft_p99_zero_ms?: number | null        // 健康评分 TTFT P99 零分点
}
