...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Clarence12138/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="${GITHUB_REPO:-Clarence12138/sub2api}"
...
Documentation=https://github.com/Clarence12138/sub2api
